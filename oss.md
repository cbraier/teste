                                        ...
                                        <div class="col-lg-4 visible-lg-inline">
                                            <div class="bubble left">
                                                ...
                                                <div class="pointerBorder"><span>O faturamento real se baseia
                                                        ...
                                                        Se,
                                                        por exemplo, 35% dos pagamentos não se concretizam, sua taxa de
                                    ...
                                    <div class="row visitas">
                                        <div
                                            ...
                                            <div class="form-group"><label for="sessions" class="control-label"
                                                ...
                                                <div style="padding: 9px; margin-top: -4px;"><span class="result"
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-8 col-md-offset-2">
                            ...
                            <h4><strong><img alt="" src="arquivos/icone_duvid_oss.png"></strong></h4>
                            <p><small></small></p>
                                ...
                                <div class="card">
                                    ...
                                    <div class="demo">
                                        ...
                                        <label class="toggle" for="uniqueID1">
                                            ...
                                            <span class="custom-blue-text"></span>
                            ...
                            <h4><strong><img alt="LGPD Ícone" src="arquivos/icone_lgpd_oss.png"> DIREITO DIGITAL E
                                    LGPD</strong></h4>
                            <p><small></small></p>
                            ...
                            <h4><strong><img alt="SAC Ícone" src="arquivos/icone_marketplace_oss.png">
                        ...
                        <html lang="pt-BR">
                            ...
                            <div class="plan-table">
                                <table>
                                    ...
                                    <tr>
                                        <td>Orçamento c/ sistema de mensageria</td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                    ...
                                    <tr>
                                        <td>Busca completa por produtos inclusive c/ motor de recomendações</td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                    ...
                                    <tr>
                                        <td>Motor de Promoções c/ várias possibilidades de configurações</td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                    ...
                                    <tr>
                                        <td>Gerenciamento de Administradores com diferentes níveis de acessos</td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                    ...
                                    <tr>
                                        <td>Open Front End - HTML, CSS e JS</td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                    ...
                                    <tr>
                                        <td>Recuperação automática de carrinhos abandonados (alerta por e-mail)</td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                    ...
                                    <tr>
                                        <td>Painel de administração individual para cada lojista</td>
                                        <td><img src="/arquivos/check_nt.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                    ...
                                    <tr>
                                        <td>Geolocalização de Clientes</td>
                                        <td><img src="/arquivos/check_nt.png" alt="Check"></td>
                                        <td><img src="/arquivos/check_nt.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                    ...
                                    <tr>
                                        <td>Painel de administração centralizado para Shopping</td>
                                        <td><img src="/arquivos/check_nt.png" alt="Check"></td>
                                        <td><img src="/arquivos/check_nt.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                    ...
                                    <tr>
                                        <td>Integração com gateways de pagamentos com Split de distribuição p/
                                            Marketplace
                                        </td>
                                        <td><img src="/arquivos/check_nt.png" alt="Check"></td>
                                        <td><img src="/arquivos/check_nt.png" alt="Check"></td>
                                    ...
                                    <tr>
                                        <td>Carrinho e check out juntos c/ várias lojas e apenas um único pagamento</td>
                                        <td><img src="/arquivos/check_nt.png" alt="Check"></td>
                                        <td><img src="/arquivos/check_nt.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                    ...
                                    <tr>
                                        <td>API de integração via Web Service (Arquitetura R.E.S.T.ful JSON)</td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                    ...
                                    <tr>
                                        <td>Suporte para Integração com Chat Online</td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                    ...
                                    <tr>
                                        <td>Integração com ClearSale2 (Versões Total Garantido e Real Time Decision)
                                        </td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                    ...
                                    <tr>
                                        <td>Google Merchant Center Integrado</td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                    ...
                                    <tr>
                                        <td>Atendimento via chamado (Zendesk)</td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                    ...
                                    <tr>
                                        <td>SLA do Atendimento via Suporte</td>
                                        <td><img src="/arquivos/check_nt.png" alt="Check"></td>
                                        <td>90,0%</td>
                                        <td>95%</td>
                                        <td>95%</td>
                                    ...
                                    <tr>
                                        <td>Gerente de Contas | Análise de Performance</td>
                                        <td><img src="/arquivos/check_nt.png" alt="Check"></td>
                                        <td>Bimestral</td>
                                        <td>Mensal</td>
                                        <td>Mensal</td>
                                    ...
                                    <tr>
                                        <td>Consultoria de Diagnóstico (2hs / 2 dias)</td>
                                        <td><img src="/arquivos/check_nt.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                    ...
                                    <tr>
                                        <td>Consultoria de Ativação (4hs / 4 dias)</td>
                                        <td><img src="/arquivos/check_nt.png" alt="Check"></td>
                                        <td><img src="/arquivos/check_nt.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                    ...
                                    <tr>
                                        <td>Consultoria de Planejamento (6hs / 4 dias)</td>
                                        <td><img src="/arquivos/check_nt.png" alt="Check"></td>
                                        <td><img src="/arquivos/check_nt.png" alt="Check"></td>
                                        <td><img src="/arquivos/check_nt.png" alt="Check"></td>
                                        <td><img src="/arquivos/check.png" alt="Check"></td>
                                    ...
                                    <tr>
                                        <td>Consultoria de Gestão (12hs / 12 dias)</td>
                                        <td><img src="/arquivos/check_nt.png" alt="Check"></td>
                                        <td><img src="/arquivos/check_nt.png" alt="Check"></td>
                                        <td><img src="/arquivos/check_nt.png" alt="Check"></td>
                                        <td><img src="/arquivos/check_nt.png" alt="Check"></td>
                                    ...
                                    <tr>
                                        <td>Consultoria Estendida (12 meses = 4hs / 4 dias)</td>
                                        <td><img src="/arquivos/check_nt.png" alt="Check"></td>
                                        <td><img src="/arquivos/check_nt.png" alt="Check"></td>
                                        <td><img src="/arquivos/check_nt.png" alt="Check"></td>
                                        <td><img src="/arquivos/check_nt.png" alt="Check"></td>
                                    ...
                                    <tr>
                                        <td>Contrato c/ Assinatura Digital</td>
                                        <td>12 meses</td>
                                        <td>12 meses</td>
                                        <td>12 meses</td>
                                        <td>12 meses</td>
                                    ...
                                    <tr>
                                        <td>Multa Contratual</td>
                                        <td>Aviso Prévio 30d</td>
                                        <td>Aviso Prévio 30d</td>
                                        <td>Aviso Prévio 30d</td>
                                        <td>Aviso Prévio 30d</td>
                                        <td>Aviso Prévio 30d</td>
                                    ...
                                    <tr>
                                        <td>Prazo de Implantação</td>
                                        <td>Até 60 dias | 10hs</td>
                                        <td>Até 90 dias | 20hs</td>
                                        <td>Até 90 dias | 30hs</td>
                                        <td>Até 120 dias | 40hs</td>
                                        <td>Até 150 dias | 50hs</td>
                                        <td>Até 180 dias | 60hs</td>
                                    </tr>
                                    <tr>
                                        <td>Valor Mensal</td>
                                        <td>Consulte</td>
                                    ...
                                    <tr>
                                        <td>Implantação | Treinamento | Homologação | Montagem (Setup em 12x)</td>
                                        <td>Consulte</td>
                                        <td>Consulte</td>
                                        <td>Consulte</td>
                                        <td>Consulte</td>
                                    ...
                                    <tr>
                                        <td>Total Mensal em 12X (Mensalidade + Setup) - 1° ano</td>
                                        <td>Consulte</td>
                                        <td>Consulte</td>
                                        <td>Consulte</td>
                                        <td>Consulte</td>
                                    ...
                                    <tr>
                                        <td>PLANO MENSAL ESCOLHIDO</td>
                                        <td><input type="radio" name="plano" value="plano1"></td>
                                        <td><input type="radio" name="plano" value="plano2"></td>
                                        <td><input type="radio" name="plano" value="plano3"></td>
                                        <td><input type="radio" name="plano" value="recomendado"></td>
                                        <td><input type="radio" name="plano" value="plano5"></td>
                                        <td><input type="radio" name="plano" value="plano6"></td>
                                    </tr>
                                    <tr>
                                        <td>PLANO SETUP | ONBOARDING ESCOLHIDO</td>
                                        <td><input type="radio" name="setup" value="setup1"></td>
                                        <td><input type="radio" name="setup" value="setup2"></td>
                                        <td><input type="radio" name="setup" value="setup3"></td>
                                        <td><input type="radio" name="setup" value="setup4"></td>
                                        <td><input type="radio" name="setup" value="setup5"></td>
                                        <td><input type="radio" name="setup" value="setup6"></td>
                                    </tr>
                                </table>
...
<div class="container">
    <div class="row">
        <div class="col-lg-12">
            <p>&nbsp;</p> 
            <h1 class="text-center">E estes outros planos abaixo servem para quem?</h1>
            ...
            <html lang="pt-BR">
                ...
                <p><small>
                        <ul class="item-list">
                            <li>Para quem está montando o seu primeiro E-commerce e não precisa de muitos recursos neste
                                primeiro momento</li>
                            <li>Para quem necessita antes de investir, conhecer o mercado online e validar seu produto
                                e/ou ideia de negócio</li>
                            <li>Para empresas sem pessoas no momento que se dediquem ao E-commerce como se fosse a loja
                                principal, mas sim apenas como uma ferramenta de apoio para a loja física</li>
                            <li>Para lojistas que precisam apenas de um show-room para orçamento ou exposição dos seus
                                produtos de forma que aos poucos possa ir dominando tudo o que acontece num E-commerce
                            </li>
                            <li>Sua empresa ainda não está pronta e preparada para tantas novidades, e por isto você não
                                deseja investir muito tempo e dinheiro neste primeiro momento</li>
        ...
        <html lang="pt-BR">
            ...
            <div class="plan-table">
                <table>
                    ...
                    <td colspan="0" style="background-color: #61CE70; color: white;"><strong>PLANOS - ONE
                            STOP
                            SHOP</strong></td>
                    <td colspan="0" style="background-color: #004983; color: white;">
                        <strong>OSS 1</strong>
                    ...
                    <td colspan="0" style="background-color: #004983; color: white;"><strong>OSS 5</strong>
                    </td>
                    <td colspan="0" style="background-color: #004983; color: white;">
                        <strong>OSS 6</strong>
                    </td>
                    <tr>
                        ...
                        <td>Implantação (Não assistida)</td>
                        <td><img src="/arquivos/check.png" alt="Check"></td>
                        <td><img src="/arquivos/check.png" alt="Check"></td>
                        <td><img src="/arquivos/check.png" alt="Check"></td>
                        <td><img src="/arquivos/check.png" alt="Check"></td>
                    ...
                    <tr>
                        <td>São + de 300 funcionalidades numa única solução</td>
                        <td><img src="/arquivos/check.png" alt="Check"></td>
                        <td><img src="/arquivos/check.png" alt="Check"></td>
                        <td><img src="/arquivos/check.png" alt="Check"></td>
                        <td><img src="/arquivos/check.png" alt="Check"></td>
                    ...
                    <tr>
                        <td>Busca completa por produtos</td>
                        <td><img src="/arquivos/check.png" alt="Check"></td>
                        <td><img src="/arquivos/check.png" alt="Check"></td>
                        <td><img src="/arquivos/check.png" alt="Check"></td>
                        <td><img src="/arquivos/check.png" alt="Check"></td>
                    ...
                    <tr>
                        <td>Integração com gateways de pagamentos
                        </td>
                        <td><img src="/arquivos/check.png" alt="Check"></td>
                        <td><img src="/arquivos/check.png" alt="Check"></td>
                        <td><img src="/arquivos/check.png" alt="Check"></td>
                    ...
                    <tr>
                        <td>Customização de Front End (Até 20 horas de desenvolvimento)</td>
                        <td><img src="/arquivos/check.png" alt="Check"></td>
                        <td><img src="/arquivos/check.png" alt="Check"></td>
                        <td><img src="/arquivos/check.png" alt="Check"></td>
                        <td><img src="/arquivos/check.png" alt="Check"></td>
                    ...
                    <tr>
                        <td>Integração via Webhooks ou Scripts de páginas</td>
                        <td><img src="/arquivos/check.png" alt="Check"></td>
                        <td><img src="/arquivos/check.png" alt="Check"></td>
                        <td><img src="/arquivos/check.png" alt="Check"></td>
                        <td><img src="/arquivos/check.png" alt="Check"></td>
                    ...
                    <tr>
                        <td>Integração com Chat Online</td>
                        <td><img src="/arquivos/check.png" alt="Check"></td>
                        <td><img src="/arquivos/check.png" alt="Check"></td>
                        <td><img src="/arquivos/check.png" alt="Check"></td>
                        <td><img src="/arquivos/check.png" alt="Check"></td>
                    ...
                    <tr>
                        <td>Integração com ClearSale2</td>
                        <td><img src="/arquivos/check.png" alt="Check"></td>
                        <td><img src="/arquivos/check.png" alt="Check"></td>
                        <td><img src="/arquivos/check.png" alt="Check"></td>
                        <td><img src="/arquivos/check.png" alt="Check"></td>
                    ...
                    <tr>
                        <td>Atendimento via chamado ou chat</td>
                        <td><img src="/arquivos/check.png" alt="Check"></td>
                        <td><img src="/arquivos/check.png" alt="Check"></td>
                        <td><img src="/arquivos/check.png" alt="Check"></td>
                        <td><img src="/arquivos/check.png" alt="Check"></td>
                    ...
                    <tr>
                        <td colspan="0" style="background-color: #61CE70; color: white;"><strong>CONDIÇÕES
                                COMERCIAIS</strong></td>
                    </tr>
                    <tr>
                        <td>Contrato On line</td>
                        <td>Anual</td>
                        <td>Anual</td>
                        <td>Anual</td>
                        <td>Anual</td>
                    ...
                    <tr>
                        <td>PLANO SETUP | ONBOARDING ESCOLHIDO Até 12x no Cartão</td>
                        <td><input type="radio" name="setup" value="setup1"></td>
                        <td><input type="radio" name="setup" value="setup2"></td>
                        <td><input type="radio" name="setup" value="setup3"></td>
                        <td><input type="radio" name="setup" value="setup4"></td>
                ...
                <section id="expectativa">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <h1 class="text-center">Para quem é o nosso Plano: Faça Você Mesmo?</h1>
                                
                            </div>

                            <div class="col-lg-16 col-md-16 col-md-offset-0">
                                <p>Estamos felizes em fazermos parte da jornada da criação do seu E-commerce.
                                        Nosso
                                        método facilitará para que você não perca
                                        o foco e consiga
                                        fazer a implantação da sua loja online de forma profissional, organizada e sem
                                        desperdícios
                                        de tempo e dinheiro.
                                        Com a nossa metodologia, suas necessidades, metas e desejos serão totalmente
                                        atendidos
                                        afim de que seu negócio online seja expansível e preparado para o presente e o
                                        futuro.
                                        Queremos portanto, que você esteja ciente do que esperamos de você através do
                                        nosso
                                        método e do que você pode esperar da gente ao longo deste processo.

                                        <h4><strong><img alt="" src="arquivos/icone_entrega_oss.png">Isto é para você
                                                se:</strong></h4>
                                        ...
                                        <html lang="pt-BR">
                                            ...
                                            <p><small>
                                                    <ul class="item-list">
                                                        <li>Você não tem certeza se o seu E-commerce está organizado
                                                            corretamente</li>
                                                        <li>Você está preocupado em fazer tudo certo desde o início da
                                                            criação
                                                            da sua loja virtual</li>
                                                        <li>Você deseja utilizar todas as ferramentas possíveis para o
                                                            seu
                                                            momento e configurar tudo certo para que seu E-commerce
                                                            funcione
                                                            corretamente</li>
                                                        <li>Você deseja ter dicas preciosas e práticas de como
                                                            configurar sua
                                                            loja online</li>
                                                        <li>Você espera que a nossa experiência guie você por todos os
                                                            passos do
                                                            seu E-commerce</li>
                                ...
                                <article>
                                    <h4><strong><img alt="" src="arquivos/icone_espera_oss.png"> Isto não é para você
                                            se:</strong></h4>
                                    <p><small>
                                            ...
                                            <html lang="pt-BR">
                                                ...
                                                <p><small>
                                                        <ul class="item-list">
                                                            <li>Você é um dos raros profissionais de E-commerce que já
                                                                domina
                                                                as ferramentas do ecossistema e configura regularmente
                                                                uma loja
                                                                online para você, um
                                                                cliente ou uma empresa</li>
                                                            <li>Você espera que alguém faça tudo por você, em vez de
                                                                aprender
                                                                como fazer sozinho</li>
                                                            <li>Você está sempre procurando um atalho, um meio mais
                                                                fácil de
                                                                resolver algo tão importante</li>
                                                            <li>Você não está disposto a investir tempo para dominar
                                                                novas
                                                                ferramentas e desenvolver seu E-commerce</li>
                                    ...
                                    <p class="/arquivos/texto_grande">
                                        Estamos comprometidos em fazer essa jornada ser bem-sucedida e
                                        gratificante. Juntos,
                                        construiremos um E-commerce que elevará sua presença online e seus
                                        resultados nos
                                        negócios.

                                        Por favor, esteja à vontade para entrar em contato conosco a qualquer
                                        momento para
                                        discutir suas ideias, preocupações, dúvidas ou perguntas. Juntos,
                                        estamos prestes a
                                        criar
                                        algo incrível à 4 mãos.</p>
                                </article>
                                </small></p>
                            </div>
                            </header>
                    ...
                    <div class="plan-table">
                        <table>
                            ...
                            <td colspan="0" style="background-color: #61CE70; color: white;"><strong>PLANO - FAÇA VOCÊ
                                    MESMO</strong></td>
                            <td colspan="0" style="background-color: #004983; color: white;">
                                <strong>SOBRE O QUE ENSINAREMOS</strong>
                            </td>
                            ...
                            <tr>
                                <td>Gateway de Pagamentos</td>
                                <td><img src="/arquivos/check.png" alt="Check"></td>

                            <tr>
                                <td>Logística de Entregas</td>
                                <td><img src="/arquivos/check.png" alt="Check"></td>
                            <tr>
                                <td>SAC - Serviço de Atendimento ao Consumidor</td>
                                <td><img src="/arquivos/check.png" alt="Check"></td>
                            <tr>
                                <td>Ferramentas de Design e Desenvolvimento</td>
                                <td><img src="/arquivos/check.png" alt="Check"></td>
                            <tr>
                                <td>Redes Sociais</td>
                                <td><img src="/arquivos/check.png" alt="Check"></td>
                            <tr>
                                <td>ERP - Sistema Integrado de Gestão</td>
                                <td><img src="/arquivos/check.png" alt="Check"></td>
                            <tr>
                                <td>Direito Digital e LGPD</td>
                                <td><img src="/arquivos/check.png" alt="Check"></td>
                            <tr>
                                <td>Markeplaces</td>
                                <td><img src="/arquivos/check.png" alt="Check"></td>
                            ...
                            <tr>
                                ...
                                <td><img src="/arquivos/check.png" alt="Check"></td>
                            <tr>
                                <td>SEO - Otimização para Mecanismos de Busca</td>
                                <td><img src="/arquivos/check.png" alt="Check"></td>
                            <tr>
                                <td>Frontend Design + UX + UI</td>
                                <td><img src="/arquivos/check.png" alt="Check"></td>
                            <tr>
                                <td>Gestão Comercial</td>
                                <td><img src="/arquivos/check.png" alt="Check"></td>
                            <tr>
                                <td>CRM - Automatização de Campanhas</td>
                                <td><img src="/arquivos/check.png" alt="Check"></td>
                            <tr>
                                <td>NPS - Net Promoter Score</td>
                                <td><img src="/arquivos/check.png" alt="Check"></td>
                            <tr>
                                <td>Vídeos e Fotografias</td>
                                <td><img src="/arquivos/check.png" alt="Check"></td>
                            <tr>
                                <td>Google Merchant Center</td>
                                <td><img src="/arquivos/check.png" alt="Check"></td>
                            <tr>
                                <td>Google AdWords - Gestão de Tráfego Pago</td>
                                <td><img src="/arquivos/check.png" alt="Check"></td>
                            <tr>
                                <td colspan="0" style="background-color: #61CE70; color: white;"><strong>CONDIÇÕES
                                        COMERCIAIS</strong></td>
                            ...
                            <tr>
                                <td>Possui contrato?</td>
                                <td>Sem contrato, mas com garantia</td>
                            </tr>

                            <tr>
                                <td>Possui Multa Contratual?</td>
                                <td>Não, apenas garantia de satisfação</td>
                            </tr>

                            <tr>
                                <td>Qual o prazo médio de Implantação?</td>
                                <td>30 dias</td>
                            </tr>
                            <tr>
                                <td>Pagamento Único</td>
                                <td>10x de R$ 99,00</td>
                            </tr>
                            <tr>
                                <td>Quero começar agora!</td>
                                <td><input type="radio" name="plano" value="plano1"></td>
                            </tr>
    ...
    <section id="contato">
        <div class="newsletter-subscribe">
            <div class="container">
                <div class="intro">
                    <h2 class="text-center">VOCÊ JÁ SABE QUE COMEÇAR CERTO O SEU E-COMMERCE É A CHAVE PARA
                        QUE ELE SEJA UM SUCESSO...</h2>
                    <p class="text-center">...CONHEÇA ENTÃO O NOSSO MÉTODO ÁGIL, PRÁTICO, RÁPIDO E SEGURO </p>
                </div>
                <form method="get" class="form-inline">
                    <div class="msg anime">
                        <p>Em breve você receberá em seu e-mail o link para o sucesso do seu E-commerce</p>
                    </div>

                    <div class="form anime">
                        <div class="form-group" style="margin-bottom: 10px;"><input type="email" id="news-email"
                                name="news-email" required="required" placeholder="Seu melhor e-mail"
                                class="form-control" style="background-color: rgb(255, 255, 255) !important;">
                        </div>

                        <div class="form-group" style="margin-bottom: 10px;"><input type="telefone" id="news-email"
                                name="news-email" required="required" placeholder="Seu telefone" class="form-control"
                                style="background-color: rgb(255, 255, 255) !important;">
                        </div>

                        <div class="form-group" style="margin-bottom: 10px;"><button type="submit"
                                class="btn btn-primary" style="background-color: #004983 !important;">Quero +
                                informações </button>
                        </div>
                    </div>
    ...
    <footer id="sobre" class="text-center">
        <div class="footer-above">
            <div class="container">
                <div class="row">
                    <div class="footer-col col-md-12">
                        <h3><i class="fa fa-share" style="margin-right: 4px;">
                            </i>Venha falar com a gente!</h3>
                        <ul class="list-inline">
                            <li>
                                <a href="http://www.facebook.com/braier" target="_blank"
                                    class="btn-social btn-outline"><i class="fa fa-fw fa-facebook"></i></a>
                            </li>
                            <li>
                                <a href="https://www.instagram.com/cristianobraier/" target="_blank"
                                    class="btn-social btn-outline"><i class="fa fa-fw fa-instagram"></i></a>
                            </li>
                            <li>
                                <a href="https://wa.me/5548998358631" target="_WHITE" class="btn-social btn-outline"><i
                                        class="fa fa-fw fa-whatsapp"></i></a>
                            </li>
                            <li>
                                <a href="http://www.linkedin.com/in/braier" target="_blank"
                                    class="btn-social btn-outline"><i class="fa fa-fw fa-linkedin"></i></a>
                            </li>
                        </ul>
                    </div>
                    <hr style="width: 70%; border-color: #61CE70; margin-bottom: 60px;">
                    <div class="footer-col col-md-6 text-left">
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1">
                                <div class="row">
                                    <div class="col-md-6 col-md-offset-3">
                                        <a href="http://www.onestopshop.center" target="_blank" title="OSS"><img
                                                src="arquivos/logo_menor_oss_v2.svg" class="img-responsive"></a>
                                    </div>
                                </div>
                                <div class="row" style="margin-top: 30px;">

                                    <div class="col-md-4">
                                        <a href="https://www.safe2pay.com.br" target="_blank" title="Safe2Pay"><img
                                                src="arquivos/safe2pay_logo.png" class="img-responsive"></a>
                                    </div>

                                    <div class="col-md-4"><a href="https://about.meta.com/br/" target="_blank"
                                            title="Meta"><img src="arquivos/meta_logo.png" class="img-responsive"></a>
                                    </div>

                                    <div class="col-md-4"><a href="https://ads.google.com/" target="_blank"
                                            title="Google"><img src="arquivos/google_logo.png"
                    ...
                    <div class="footer-col col-md-6 text-left about">
                        <h3>O que fazemos?</h3>
                        <p>A <a href="http://onestopshop.center/" target="_self">One Stop Shop</a>, é especializada
                            em diagnosticar as necessidades de cada negócio, na construção de lojas online,
                            na elaboração do planejamento estratégico e na consultoria de gestão de negócios
                            digitais de alta performance. <a href="SITE" target="_blank"></a> <a href="SITE"
                                target="_blank"></a><a href="HUB" target="_blank"></a></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        Copyright © One Stop Shop (OSS) 2023 - Ecossistema para E-commerce - Expert em Canais
                        Digitais
                    </div>
                </div>
            </div>
...
<script src="arquivos/bundle.js"></script>
<script src="arquivos/copy-link.js"></script>
<script src="arquivos/custom.js"></script>
<script src="arquivos/jquery.numbox-1.3.0.min.js"></script>





    <!-- Outros elementos head, como meta tags e links para CSS -->
    <style>
        .whatsapp-button {
            position: fixed;
            bottom: 20px;
    ...
    <div id="whatsapp-container">
        <a href="https://api.whatsapp.com/send?phone=5548998358631&text=Olá,%20gostaria%20de%20conversar%20sobre%20E-commerce%20e%20conhecer%20o%20método"
            target="_blank" class="whatsapp-button">
            <img src="/arquivos/chat_v3.png" alt="WhatsApp">
        </a>
    </div>
